...
# running
gpu_id = 0                   # gpu id
nb_epochs_train = 60         # number of epochs to train for
...
data_path = '/mnt/data_2/singlecoil_train/'  # directory of your data. See next section.
...
xdata = np.concatenate([np.load(f) for f in files])[..., np.newaxis]
...
# Modiflied to allow MULTI GPU Support:
